...
CSS Moderno: Estilização focada em experiência de utilizador (UX).
Backend
...
CORS Middleware: Configuração de segurança para permitir a comunicação fluida entre domínios.
...
API (FastAPI)
Recebe os pedidos do site, valida os dados e guarda-os na base de dados.
Vigilante (Worker)
Um "script" independente que monitoriza o relógio e os agendamentos pendentes.
Painel Web (React)
Interface intuitiva onde o utilizador define o número, a mensagem e o horário.
...
Aceda ao sistema através de http://localhost:5173.
Desenvolvido com foco em eficiência e automação por Fernando Ivo Negreiro da Silva.
